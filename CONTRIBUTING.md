...
2. **Clone** your fork:
   ```bash
   git clone https://github.com/<your-username>/git-why.git
   cd git-why
   ```
...
5. Open a PR against `main` on [phoenix-assistant/git-why](https://github.com/phoenix-assistant/git-why)
...
Use the [GitHub Issues](https://github.com/phoenix-assistant/git-why/issues) tracker. Please:
